# This repo has been created with the aim of documenting the solution to challenges on most competitive programming platforms using the [RUST](https://www.rust-lang.org/) programming language
